...
{
    public delegate void EventHandlerRecievedObject(object obj, SocketData data);
    public class SocketData
    {

        public static byte[] FlagBegin = new byte[] { 1, 5, 2, 45, 8, 4, 55, 77, 22, 43, 1, 0, 57 };
        public static byte[] FlagEnd = new byte[] { 1, 5, 2, 46, 8, 4, 55, 77, 22, 43, 1, 88, 57 };

        private Socket m_Socket;
        private byte[] m_Buffer;
        private List<byte> m_Data;

        public SocketData(Socket s,byte[] buf)
        {
            m_Socket = s;
            m_Buffer = buf;
    ...
    0x2d02ef8d
        ...
        public static bool FindFlag(byte[] array, byte[] flag, bool begin)
        {
